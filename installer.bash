...
then
    ...
    printf "Location is a valid directory.\n"
    ...
    eval cd "$location"
    git clone git@github.com:DavidMacDonald11/Sea-Programming-Language.git sea_lang
...
printf "You may need to restart your terminal to cement these changes.\n"
